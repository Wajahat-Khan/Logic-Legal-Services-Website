    ...
    var ConvertPlus = {
        ...
        update_impressions: function(styles){
            ...
            jQuery.ajax({
                ...
                success: function(result){// do your stuff
                },
                timeout: 1000,
            });
        },
        ...
        /**
         * [_count_inline_impressions description]
         * @return {[type]} [description]
         */
        ...
        /**
         * [_close_button_tootip description]
         * @return {[type]} [description]
         */
